...
<!-- 在修改此项目任何代码之前，请先阅读 ARCHITECTURE.md 了解完整架构和所有函数说明 -->
<!-- Before making any changes to this project, read ARCHITECTURE.md first for the full architecture and API reference -->
> **必读**：[ARCHITECTURE.md](ARCHITECTURE.md) — 完整架构、所有函数、数据结构、编码约定、扩展指南

## 功能特性

1. 需要将 [logic_gui_laoer.py](Fuyutsui/Fuyutsui/logic_gui_laoer.py) 复制到 `Fuyutsui\Fuyutsui` 下使用。
